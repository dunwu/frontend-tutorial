...
import items from '../../menu'; // 由于webpack中的设置, 不用写完整路径
...
class SideBar extends React.PureComponent {
  ...
  transFormMenuItem(obj, paths, isLevel1) {
    ...
    console.debug('transform %o to path %s', obj, parentPath);
  ...
  handleOpenChange = (openKeys) => {
    ...
    console.debug('old open keys: %o', openKeys);
    const newOpenKeys = [];
    ...
    console.debug('new open keys: %o', newOpenKeys);
