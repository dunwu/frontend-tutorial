...
- [1. Vuex 简介](#1-vuex-简介)
  ...
  - [1.2. 什么时候用 Vuex](#12-什么时候用-vuex)
  - [1.3. 安装](#13-安装)
- [2. Hello World 示例](#2-hello-world-示例)
- [3. State](#3-state)
  - [3.1. 单一状态树](#31-单一状态树)
  - [3.2. 获得 Vuex 状态](#32-获得-vuex-状态)
  - [3.3. `mapState` 辅助函数](#33-mapstate-辅助函数)
  - [3.4. 对象展开运算符](#34-对象展开运算符)
  - [3.5. 组件仍然保有局部状态](#35-组件仍然保有局部状态)
- [4. Getters](#4-getters)
  - [4.1. 通过属性访问](#41-通过属性访问)
  - [4.2. 通过方法访问](#42-通过方法访问)
  - [4.3. `mapGetters` 辅助函数](#43-mapgetters-辅助函数)
- [5. Mutation](#5-mutation)
  - [5.1. 提交载荷（Payload）](#51-提交载荷payload)
  - [5.2. 对象风格的提交方式](#52-对象风格的提交方式)
  - [5.3. Mutation 需遵守 Vue 的响应规则](#53-mutation-需遵守-vue-的响应规则)
  - [5.4. 使用常量替代 Mutation 事件类型](#54-使用常量替代-mutation-事件类型)
  - [5.5. Mutation 必须是同步函数](#55-mutation-必须是同步函数)
  - [5.6. 在组件中提交 Mutation](#56-在组件中提交-mutation)
- [6. Actions](#6-actions)
  - [6.1. 分发 Action](#61-分发-action)
  - [6.2. 在组件中分发 Action](#62-在组件中分发-action)
  - [6.3. 组合 Action](#63-组合-action)
- [7. Modules](#7-modules)
  - [7.1. 模块的局部状态](#71-模块的局部状态)
  - [7.2. 命名空间](#72-命名空间)
  - [7.3. [#](https://vuex.vuejs.org/zh/guide/modules.html#模块动态注册)模块动态注册](#73-httpsvuexvuejsorgzhguidemoduleshtml模块动态注册模块动态注册)
  - [7.4. 模块重用](#74-模块重用)
- [8. 参考资料](#8-参考资料)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210402162638.png)
...
![](https://raw.githubusercontent.com/dunwu/images/dev/snap/20210402162853.png)
